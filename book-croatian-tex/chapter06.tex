...
\end{tabular}
\end{center}
To je kod \key{konstantne duljine}
što znači da je duljina svake
kodne riječi jednaka.
Na primjer, znakovni niz
\texttt{AABACDACA} možemo komprimirati kako slijedi:
\[00\,00\,01\,00\,10\,11\,00\,10\,00\]
Uz taj kod duljina komprimiranog
znakovnog niza je 18 bitova.
Međutim, znakovni niz možemo komprimirati bolje
ako upotrijebimo kod \key{varijabilne duljine}
u kojem kodne riječi mogu imati različite duljine.
