\documentclass[twoside,12pt,a4paper,croatian]{book}
...
\date{Radna verzija, \today}

\usepackage[a4paper,vmargin=30mm,hmargin=33mm,footskip=15mm]{geometry}

\title{\Huge Priručnik za natjecateljsko programiranje}
