...
\section{Problem novčića}

Najprije se usredotočimo na zadatak koji smo
već vidjeli u poglavlju 6:
Zadan je skup vrijednosti novčića $\texttt{coins} = \{c_1,c_2,\ldots,c_k\}$
i ciljni iznos novca $n$, a naš je zadatak
oblikovati sumu $n$ koristeći što manje novčića.

U poglavlju 6 taj smo zadatak riješili
pohlepnim algoritmom koji uvijek bira najveći
mogući novčić.
Pohlepni algoritam radi, na primjer,
kada su novčići euro-kovanice,
...
radi za bilo koji skup novčića.
...
potproblema.
U problemu novčića prirodan rekurzivni
zadatak glasi ovako:
koji je najmanji broj novčića
potreban za oblikovanje sume $x$?

Neka $\texttt{solve}(x)$
označava najmanji
broj novčića potreban za sumu $x$.
Vrijednosti funkcije ovise o
vrijednostima novčića.
...
jer su potrebna barem 3 novčića
...
Ideja je usredotočiti se na \emph{prvi}
novčić koji biramo za sumu.
Na primjer, u gornjem scenariju
prvi novčić može biti 1, 3 ili 4.
Ako najprije odaberemo novčić 1,
preostali zadatak je oblikovati sumu 9
koristeći najmanji broj novčića,
što je potproblem izvornog zadatka.
Naravno, isto vrijedi za novčiće 3 i 4.
Stoga možemo koristiti sljedeću rekurzivnu formulu
za izračun najmanjeg broja novčića:
\begin{equation*}
\begin{split}
...
jer za oblikovanje prazne sume nije potreban nijedan novčić.
Na primjer,
\[ \texttt{solve}(10) = \texttt{solve}(7)+1 = \texttt{solve}(4)+2 = \texttt{solve}(0)+3 = 3.\]

Sada smo spremni napisati opću rekurzivnu funkciju
koja izračunava najmanji broj
novčića potreban za oblikovanje sume $x$:
\begin{equation*}
...
sve mogućnosti kako odabrati prvi novčić
sume.
...
gdje je $n$ ciljna suma, a $k$ broj novčića.
...
ispis novčića koji se pojavljuju u optimalnom rješenju za
sumu $n$:
\begin{lstlisting}
while (n > 0) {
    cout << first[n] << "\n";
...
problema novčića u kojoj je naš zadatak
izračunati ukupan broj načina
da se proizvede suma $x$ koristeći novčiće.
